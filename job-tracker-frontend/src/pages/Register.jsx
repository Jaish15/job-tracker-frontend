      ...
      <div className="lv-reg-card">
        ...
        <form onSubmit={handleSubmit} noValidate className="lv-reg-form">
          ...
          <div className="si-social-row" style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
            <button type="button" onClick={() => window.location.href = `${API_BASE_URL}/auth/google`} className="si-social-btn" aria-label="Google" style={{ padding: '0.75rem 2rem', borderRadius: '12px', border: '1px solid #e5e7eb', background: '#fff', cursor: 'pointer' }}>
            ...
            <button type="button" onClick={() => window.location.href = `${API_BASE_URL}/auth/apple`} className="si-social-btn" aria-label="Apple" style={{ padding: '0.75rem 2rem', borderRadius: '12px', border: '1px solid #e5e7eb', background: '#fff', cursor: 'pointer' }}>
            ...
            <button type="button" onClick={() => window.location.href = `${API_BASE_URL}/auth/facebook`} className="si-social-btn" aria-label="Facebook" style={{ padding: '0.75rem 2rem', borderRadius: '12px', border: '1px solid #e5e7eb', background: '#fff', cursor: 'pointer' }}>
